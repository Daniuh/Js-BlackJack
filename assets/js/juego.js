...
let partidaJugador     = 0;
let partidaComputadora = 0;
...
const partidaJugadorG     = document.querySelector('#small-historial-player');
const partidaComputadoraG = document.querySelector('#small-historial-computer');
